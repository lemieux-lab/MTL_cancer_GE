...
"nfolds" => 5,  "nepochs" => 10_000, "mb_size" => 200, "ae_lr" => 1e-3, "ae_wd" => 5e-5, "cph_wd" => 1e-3, "dim_redux" => 10, 
"enc_hl_size" => 128, "dec_nb_hl" => ae_nb_hls, "dec_hl_size" => 128, "enc_nb_hl" =>ae_nb_hls, 
"nb_clinf"=>5, "cph_lr" => 1e-4, "cph_nb_hl" => 2, "cph_hl_size" => 64)
clinf = assemble_clinf(brca_prediction)
dump_cb_brca = dump_aecphdnn_model_cb(1000, labs_appdf(brca_prediction.stage), export_type = "pdf")
