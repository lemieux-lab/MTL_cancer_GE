...
for (i, noise_size) in enumerate(noise_sizes)
    ...
    best_model, best_model_fold, outs_test, yt_test, ye_test, outs_train, yt_train, ye_train = validate_cphdnn_clinf!(brca_cphdnnclinf_params, brca_prediction_NOISE, brca_cphdnnnoise_cb, clinf)
end 
